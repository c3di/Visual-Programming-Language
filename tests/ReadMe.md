...
>[kornia.filters.bilateral_blur(*input*, *kernel_size*, *sigma_color*, *sigma_space*, *border_type='reflect'*, *color_distance_type='l1'*)](https://kornia.readthedocs.io/en/latest/_modules/kornia/filters/bilateral.html#bilateral_blur)
